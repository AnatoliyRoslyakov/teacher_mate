...
class CalendarTextStyle {
  ...
  static TextStyle get b7f32 => _baseFonts.copyWith(
  ...
  static TextStyle get b5 => _baseFonts.copyWith(
        fontWeight: FontWeight.w500,
        color: Colors.black87,
      );

  static TextStyle get b4 => _baseFonts.copyWith(
        fontWeight: FontWeight.w400,
        color: Colors.black87,
        height: 0,
      );

  static TextStyle get b3 => _baseFonts.copyWith(
        fontWeight: FontWeight.w300,
        color: Colors.black87,
        height: 0,
      );
