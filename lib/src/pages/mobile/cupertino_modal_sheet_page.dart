...
const double sheetOffset = 14;
const double displayCornerRadius = 38.5;
const double sheetCornerRadius = 16;
const double scaleFactor = 1 / 12;
const double breakpointWidth = double.infinity;
const Size maxSize = Size.infinite;
...
class CupertinoModalSheetPage<T> extends Page<T> {
  ...
  const CupertinoModalSheetPage({required this.builder, super.key});
